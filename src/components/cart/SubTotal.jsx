    ...
    <div className="">
      <div className="seg_bg_primary p-3 mb-2">
        ...
        <Link
          ...
          href="/checkout"
          className="text-lg flex justify-center disabled:cursor-not-allowed mx-auto mt-1 rounded-md text-slate-100 bg-blue-600 hover:bg-blue-500 transition-all p-1 font-medium"
        >
          Checkout (
